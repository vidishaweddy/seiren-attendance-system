<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditPngjr.aspx.cs" Inherits="EditDosen" %>
                	...
                	<div id="welcome_screen_outer1">
                        ...
                        <div id="menu">              
                                ...
                                <div id="Admin">
                                    ...
                                    <asp:HyperLink ID="mk" runat="server" Font-Bold="True" Font-Names="Comic Sans MS"
                                        Font-Size="Medium" NavigateUrl="~/GetMKforPngjr.aspx" Text="Tambah Mata Kuliah"
                                        Width="167px"></asp:HyperLink></div>
