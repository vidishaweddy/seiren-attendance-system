<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditMhs.aspx.cs" Inherits="EditMhs" %>
    ...
    <div id="container">        	
			...
			<!--end of main section-->
                	<div id="welcome_screen_outer1">
                        ...
                        <div id="menu">              
                                <div id="New">
                                    <asp:Label ID="Label1" runat="server" Text="Student's Photo" Width="148px" Font-Bold="True" Font-Names="Comic Sans MS" Font-Size="Medium" ></asp:Label>
                                    <div id="image">
                                    ...
                                    <asp:Label ID="Label2" runat="server" Text="Fingerprint Image" Width="148px" Font-Bold="True" Font-Names="Comic Sans MS" Font-Size="Medium" ></asp:Label>
                                    <div id="imageFinger"></div>
                                    <asp:Label ID="Label3" runat="server" Text="Barcode Image" Width="148px" Font-Bold="True" Font-Names="Comic Sans MS" Font-Size="Medium" ></asp:Label>
                                    <div id="imageBarcode"></div>
                                </div>
                                <div id="Admin">
                                    ...
                                    <asp:Button ID="Button1" Text="Cek" runat="server" Width="56px" Visible="true" OnClick="Button1_Click" />
                                    <asp:Label
                                        ID="Label5" runat="server" Font-Bold="True" Font-Names="Comic Sans MS" Font-Size="Medium"
                                        Height="26px" Text="Nama Mahasiswa" Width="200px"></asp:Label><asp:TextBox ID="TextBox2"
                                    ...
                                    <asp:Label ID="Label9" runat="server" Font-Bold="True" Font-Names="Comic Sans MS"
                                        Font-Size="Medium" Height="26px" Text="Fakultas" Width="200px"></asp:Label>
                                    <asp:DropDownList ID="DropDownList1" runat="server" Height="25px" Width="200px" AutoPostBack="True" DataTextField="Nama_Fakultas" DataValueField="Nama_Fakultas" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                                    </asp:DropDownList>
                                    <asp:Label ID="Label10" runat="server" Font-Bold="True" Font-Names="Comic Sans MS"
                                        Font-Size="Medium" Height="26px" Text="Program Studi" Width="200px"></asp:Label>
                                    <asp:DropDownList ID="DropDownList2" runat="server" DataTextField="Nama_Prodi" DataValueField="Nama_Prodi" Height="25px" Width="200px">
                                    </asp:DropDownList><asp:Label ID="Label11" runat="server" Font-Bold="True" Font-Names="Comic Sans MS"
                                    ...
                                    <asp:Label ID="Label17" runat="server" Font-Bold="True" Font-Names="Comic Sans MS"
                                        Font-Size="Medium" Height="27px" Text="Alamat" Width="200px"></asp:Label><asp:TextBox
                                            ID="TextBox12" runat="server" Height="20px" Width="194px"></asp:TextBox><br />
                                    <asp:Label ID="Label16" runat="server" Font-Bold="True" Font-Names="Comic Sans MS"
                                        Font-Size="Medium" Height="27px" Text="Email" Width="200px"></asp:Label><asp:TextBox
                                            ID="TextBox11" runat="server" Height="20px" Width="194px"></asp:TextBox><asp:Label
                                                ID="Label12" runat="server" Font-Bold="True" Font-Names="Comic Sans MS" Font-Size="Medium"
                                                Height="27px" Text="Semester" Width="200px"></asp:Label><asp:TextBox ID="TextBox7"
                                                    runat="server" Height="20px" Width="194px"></asp:TextBox><asp:Label ID="Label13"
                                                        runat="server" Font-Bold="True" Font-Names="Comic Sans MS" Font-Size="Medium"
                                                        Height="26px" Text="IPK" Width="200px"></asp:Label><asp:TextBox ID="TextBox8" runat="server"
                                                            Height="20px" Width="194px"></asp:TextBox><asp:Label ID="Label14" runat="server"
                                                                Font-Bold="True" Font-Names="Comic Sans MS" Font-Size="Medium" Height="26px"
                                                                Text="Nama Orang Tua" Width="200px"></asp:Label><asp:TextBox ID="TextBox9" runat="server"
                                                                    Height="20px" Width="194px"></asp:TextBox><asp:Label ID="Label15" runat="server"
                                                                        Font-Bold="True" Font-Names="Comic Sans MS" Font-Size="Medium" Height="26px"
                                                                        Text="Alamat Orang Tua" Width="200px"></asp:Label><asp:TextBox ID="TextBox10" runat="server"
                                                                            Height="20px" Width="194px"></asp:TextBox><br /><asp:HyperLink ID="mk" Font-Bold="True" Font-Names="Comic Sans MS" Font-Size="Medium" NavigateUrl="~/SetMKforPljr.aspx" Text="Tambah Mata Kuliah" runat="server" Width="167px"></asp:HyperLink></div>
                                <div id="Browse" style="width: 615px">
                                <asp:DataGrid id="DataGrid"  AutoGenerateColumns="False" AllowSorting="True" runat="server" CellPadding="3" GridLines="Vertical" Height="70px" Width="575px" Font-Bold="False" Font-Italic="False" Font-Names="Comic Sans MS" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Left" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" AllowPaging="True" PageSize="25" >
											...
											<Columns>
                                                    ...
                                                    <asp:BoundColumn HeaderText="Nama Mahasiswa" 
                                                    SortExpression="Nama Mahasiswa"
                                                      DataField="Nama Mahasiswa" />
                                                    <asp:BoundColumn HeaderText="Data Fingerprint"
                                                    SortExpression="Data Fingerprint" 
                                                      DataField="Data Fingerprint" />
                                                      <asp:BoundColumn HeaderText="Data Barcode"
                                                    SortExpression="Data Barcode" 
                                                      DataField="Data Barcode" />
                                            </Columns>
