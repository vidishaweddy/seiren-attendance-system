<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditMK.aspx.cs" Inherits="EditMK" %>
                	...
                	<div id="welcome_screen_outer1">
                        ...
                        <div id="menu">    
                                <div id="Admin">
                                    ...
                                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Cek" Width="56px" />
                                    <asp:Label
