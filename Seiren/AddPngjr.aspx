<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddPngjr.aspx.cs" Inherits="AddDosen" %>
                	...
                	<div id="welcome_screen_outer1">
                        ...
                        <div id="menu">              
                                ...
                                <div id="Admin">
                                    ...
                                    <input id="TextBox4" name="TextBox4" runat="server" readonly="readonly" style="height:20px; width:194px" type="text"/><asp:Label
                                    ...
                                    <asp:Label ID="Label16" runat="server" Font-Bold="True" Font-Names="Comic Sans MS"
                                        Font-Size="Medium" Height="27px" Text="Email" Width="200px"></asp:Label><asp:TextBox
                                            ID="TextBox8" runat="server" Height="20px" Width="194px"></asp:TextBox><br /></div>
