<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddMhs.aspx.cs" Inherits="_Default" %>
                        ...
                        <div id="menu">              
                                <div id="New">
                                    ...
                                    <div id="image">
                                        ...
                                        <asp:Button ID="ButtonShow" Text="Show Browsing Picture" runat="server" Width="160px" Visible="true" OnClick="ButtonShow_Click" />
                                                                ...
                                                                Text="Nama Orang Tua" Width="200px"></asp:Label><asp:TextBox ID="TextBox9" runat="server"
                                                                    Height="20px" Width="194px"></asp:TextBox><asp:Label ID="Label15" runat="server"
                                                                        ...
                                                                        Text="Alamat Orang Tua" Width="200px"></asp:Label><asp:TextBox ID="TextBox10" runat="server"
                                                                            Height="20px" Width="194px"></asp:TextBox><br /></div>
